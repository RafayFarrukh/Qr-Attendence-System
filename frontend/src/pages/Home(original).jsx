...
import EasyIntegration from '../css/images/EasyIntegration.jpeg';
import Analytics from '../css/images/Analytics.png';
...
const Home = () => {
  ...
  return (
    <>
      <header>
        <Navbar openModal={handleModalOpen} open={modalOpen} />
      </header>
      ...
      <section className='bg-gray-100 py-12 px-6'>
        ...
        <div className='grid grid-cols-3 gap-8'>
          <div className='flex flex-col items-center'>
            ...
            />
            <h3 className='text-xl font-bold text-gray-900 mb-2'>Easy Scan</h3>
            <p className='text-gray-700 text-center'>
              Simply scan the QR code with our app to track attendance.
            </p>
          </div>
          <div className='flex flex-col items-center'>
            <img src={Analytics} alt='Feature 2' className='w-32 h-32 mb-4' />
            <h3 className='text-xl font-bold text-gray-900 mb-2'>
              Real-time Analytics
            </h3>
            <p className='text-gray-700 text-center'>
              Get instant access to attendance analytics and reports.
            </p>
          </div>
          <div className='flex flex-col items-center'>
            <img
            ...
            <p className='text-gray-700 text-center'>
              Seamlessly integrate our app with your existing attendance system.
            </p>
          </div>
        </div>
      </section>
        ...
        <div class='mx-auto max-w-screen-xl'>
            ...
            <div class='grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3'>
              ...
              <div>
                ...
                <ul class='text-gray-600 dark:text-gray-400'>
                  ...
                  <li>
                    <a href='https://discord.com' class='hover:underline'>
                      Discord
                    </a>
                  </li>
                </ul>
          ...
          <div class='sm:flex sm:items-center sm:justify-between'>
            <span class='text-sm text-gray-500 sm:text-center dark:text-gray-400'>
              © 2023{' '}
              <a
                href='https://qr-attendence-system.vercel.app/'
                class='hover:underline'
              >
                Qr Attendance App
              </a>
